...
public class Magpie3 {
	...
	public String getResponse(String statement) {
		...
		} else if (findKeyword(statement, "sugar") >= 0) {
			response = "Sugar what bro?";
		} else if (findKeyword(statement, "Scott") >= 0) {
			response = "You mean Scoot Ponzer?";
		} else if (findKeyword(statement, "Cayden") >= 0) {
